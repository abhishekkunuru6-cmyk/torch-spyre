...
def main() -> None:
    ...
    print()
    print("  GQA is NOT the variable: B=2 H=4 fails identically as MHA and as")
    print("  GQA.  B*H is not it either: B=1 H=8 passes and B=2 H=4 fails at the")
    print("  same B*H=8.  What splits the results is B > 1 together with H >= 4;")
    print("  every B=1 shape passes (H=2, 4, 8; MHA and GQA; Lq 256 and 512).")
    if not args.compile:
        print()
