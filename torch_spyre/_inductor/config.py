...
# Route spyre::sliding_window_attention through the rolled-window path: copy one
# Q block's window into a buffer and attend against that, one block at a time,
...
swa_window_roll: bool = os.environ.get("SPYRE_SWA_WINDOW_ROLL", "0") == "1"
